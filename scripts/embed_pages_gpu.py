...
RunPod recipe (PyTorch template, 24 GB GPU, 40 GB volume):
    ...
    pip install -q "transformers>=4.45,<5" accelerate einops sentencepiece datasets pypdfium2 Pillow huggingface_hub hf_transfer docling
    # datasets: the model's remote code imports it, and the RunPod PyTorch template does not ship it
