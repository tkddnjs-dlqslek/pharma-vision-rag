...
| 평가셋 30문항 | ✅ v2 문서 id와 전체본 페이지 번호로 이전. gold는 "정답이 실린 모든 페이지" 기준으로 보완, 멀티홉은 `gold_groups` |
...
| 평가셋 확장 | ❌ 30에서 60문항으로. 연도 간, 회사 간 문항 추가. A01, A03, A06 재설계 필요(2024 보도자료에 같은 수치가 텍스트로 있음) |
